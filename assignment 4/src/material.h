...
public:
  ...
  virtual const Vec3f& getSpecularColor() const = 0;
  virtual const Vec3f& getReflectiveColor() const = 0;
  virtual const Vec3f& getTransparentColor() const = 0;
  virtual const float getIndexOfRefraction() const = 0;
...
public:
  ...
  PhongMaterial::PhongMaterial(const Vec3f &diffuseColor, 
                  ...
                  float exponent): Material(diffuseColor){
  ...
  const Vec3f& getTransparentColor() const;
